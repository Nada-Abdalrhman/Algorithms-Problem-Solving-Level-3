namespace Sum_Each_Row_in_Matrix;
...
class Program
{
    static void Main(string[] args)
    {
        ...
        PrintSumOfEachRow($"The following are the sum of each row in the matrix: ", arr);
        Console.WriteLine("--------------------");
        var arr2 = FillArr(9, 9, 5, 500);
        PrintSumOfEachRow($"The following are the sum of each row in the matrix: ", arr2);
